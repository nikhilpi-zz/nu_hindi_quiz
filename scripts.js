$(document).ready( function() { 
                    ...
                    yes: {
                        ...
                        options: {
                            yes: {
                                ...
                                question: "That’s great! Can you read the Nastaliq ('Urdu') script as well?",
                                options: {
                                    yes: { text: 3 },
                                    no: { text: 4 }
                                }
                            ...
                            no: {
                                ...
                                question: "No problem. Can you read and write in the Nastaliq ('Urdu') script?",
                                options: {
                                    yes: { text: 6 },
                                    no: { text: 5 }
                                }
    ...
    var text_db = [
        // 1
        {text: 'not sure what will go here yet.'},

        //2
        {
            text: 'So you\'re interested in learning Hindi-Urdu with us here at Northwestern? That\'s great! We\'ll have you singing along to Bollywood songs in no time. Since you\'re new to the language, we recommend that you join our first-year classes, where you\'ll learn to speak, read and write Hindi-Urdu in both of its scripts. For more information, <a href="#more_info2" data-toggle="collapse">click here<a>',
        ...
        {
            header: 'Uraa diya!',
            text: 'You have a strong knowledge of Hindi and Urdu and you can them in both scripts. That makes you a perfect fit for our entire series of upper-level classes, or Hindi-Urdu IV: Advanced Topics in Hindi-Urdu (Hindi-Urdu 310). These classes are designed for native speakers and for the advanced language learners. The topics vary from quarter to quarter, so we\'re sure to have some offerings that will be of interest to you. Some of these topics include Hindi and Urdu literature, Indian and Pakistani Cinema and Television, and historical and regional focuses. To learn what topics are coming up next, or for more information, please send an email to to our Hindi-Urdu language coordinator, Rami Nair at rnair@northwestern.edu. For questions related to advanced topics in Urdu literature, you can also write to Daniel Majchrowicz (dmaj@northwestern.edu), and for Hindi, write to Laura Brueck (laura.brueck@northwestern.edu.)'
        },
        
        //4
        {
            header: 'Great!',
            text: 'So you can read Devanagri comfortably but you don\'t know the nastaliq script. That qualifies you to join our many of our advanced courses on Hindi-Urdu literature and culture. These classes are designed for native speakers and for the advanced language learners and will explore the vast literary and cultural world of these langauges. The topics vary from quarter to quarter, so we\'re sure to have some offerings that will be of interest to you. Some of these courses require a knowledge of both Devanagri and Nastaliq, while others are exclusive to a single script (depending on the topic.) Since you currently know one script but not the other, there are two options for you: <br><br> Option one: You can sign up for any of our advanced (Hindi-Urdu 310) courses that are taught exclusively in the Devanagri script. These courses are not offered every quarter; for more information on upcoming literature and culture classes that will be taught in Devanagri you can drop a note to our Hindi-Urdu language program coordinator, Rami Nair at rnair@northwestern.edu. <br><br> Option two: You can gain access to our full suite of courses (and to the full world of Hindi and Urdu literature and culture) by enrolling in our “Hindi-Urdu Literacy Course.” In this one quarter class, you will learn to read the “Urdu” script and emerge capable of reading books and poems in nasta\'liq. Once you\'ve finished this class, you\'ll also have access to our courses that are taught in both scripts, as well as those that are taught in Nastaliq or Devanagri alone.',
        },
